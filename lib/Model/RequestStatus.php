 ...
 */
class RequestStatus implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets statusCode
     *
     * @param  int  $statusCode  The status code of the response. Usually, but not necessarliy the HTTP status code.
     * @return self
     */
