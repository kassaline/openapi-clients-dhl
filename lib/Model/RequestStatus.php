...
class RequestStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets statusCode
     *
     * @param int $statusCode The status code of the response. Usually, but not necessarliy the HTTP status code. Same as attribut \"status\" but deprecated. Do not use. Will be removed in the next major version.
     *
     * @return self
     */
