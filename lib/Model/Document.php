...
class Document implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public const PRINT_FORMAT__910_300_700_710 = '910-300-700/710';
    ...
    public function getPrintFormatAllowableValues()
    {
        return [
            ...
            self::PRINT_FORMAT__910_300_700_710,
     ...
     * Sets printFormat
     *
     * @param  string|null  $printFormat  The print format used. Customs documents cash on delivery documents can only be returned in format A4.
     * @return self
     */
