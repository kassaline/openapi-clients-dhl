 ...
 */
class Shipper implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public function setAddressStreet($addressStreet)
    {
        ...
        if ((mb_strlen($addressStreet) > 50)) {
            throw new \InvalidArgumentException('invalid length for $addressStreet when calling Shipper., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($addressStreet) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addressStreet when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressHouse($addressHouse)
    {
        ...
        if ((mb_strlen($addressHouse) > 10)) {
            throw new \InvalidArgumentException('invalid length for $addressHouse when calling Shipper., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($addressHouse) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addressHouse when calling Shipper., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling Shipper., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($postalCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling Shipper., must be bigger than or equal to 3.');
        }
        if ((! preg_match('/^[0-9A-Za-z]+([ -]?[0-9A-Za-z]+)*$/', ObjectSerializer::toString($postalCode)))) {
            throw new \InvalidArgumentException('invalid value for $postalCode when calling Shipper., must conform to the pattern /^[0-9A-Za-z]+([ -]?[0-9A-Za-z]+)*$/.');
        }
    ...
    public function setContactName($contactName)
    {
        ...
        if ((mb_strlen($contactName) > 80)) {
            throw new \InvalidArgumentException('invalid length for $contactName when calling Shipper., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($contactName) < 3)) {
            throw new \InvalidArgumentException('invalid length for $contactName when calling Shipper., must be bigger than or equal to 3.');
        }
