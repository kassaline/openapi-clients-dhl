 ...
 */
class ShipmentOrderRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'profile' => 'string',
        'shipments' => '\OpenAPI\Client\Dhl\Model\Shipment[]',
    ];
     ...
     * Gets shipments
     *
     * @return \OpenAPI\Client\Dhl\Model\Shipment[]
     */
     ...
     * Sets shipments
     *
     * @param  \OpenAPI\Client\Dhl\Model\Shipment[]  $shipments  Shipment array having details for each shipment.
     * @return self
     */
