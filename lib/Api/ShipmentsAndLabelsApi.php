...
class ShipmentsAndLabelsApi
{
     ...
     *
     * @param  \OpenAPI\Client\Dhl\Model\ShipmentOrderRequest $shipmentOrderRequest Shipment order request. (required)
    ...
    {
        list($response) = $this->createOrdersWithHttpInfo($shipmentOrderRequest, $acceptLanguage, $validate, $mustEncode, $includeDocs, $docFormat, $printFormat, $retourePrintFormat, $combine, $contentType);
        return $response;
    }
    ...
    {
        list($response) = $this->getOrderWithHttpInfo($shipment, $acceptLanguage, $docFormat, $printFormat, $retourePrintFormat, $includeDocs, $combine, $contentType);
        return $response;
    }
    ...
    {
        list($response) = $this->ordersAccountDeleteWithHttpInfo($profile, $shipment, $acceptLanguage, $contentType);
        return $response;
    }
